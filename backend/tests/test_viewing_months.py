...
class TestViewingMonth:
    ...
    def test_is_good_month_poor(self):
        ...
        month = ViewingMonth(
            month=6,
            month_name="June",
            rating=MonthRating.POOR,
            visibility_hours=2.0,
            best_time="03:00"
        )
...
class TestViewingMonthsService:
    ...
    def test_calculate_viewing_months_circumpolar(self, service):
        ...
        months = service.calculate_viewing_months(
            ra_hours=2.530,  # Near north celestial pole
            dec_degrees=89.26,
            latitude=40.0,
            object_name="Polaris"
        )
    ...
    def test_calculate_altitude_at_transit(self, service):
        ...
        altitude = service._calculate_altitude_at_transit(
            dec_degrees=40.0,
            latitude=40.0
        )
    ...
    def test_is_visible_from_latitude(self, service):
        ...
        assert service._is_visible_from_latitude(
            dec_degrees=50.0,
            latitude=40.0
        ) is True
    ...
    def test_calculate_visibility_hours(self, service):
        ...
        hours = service._calculate_visibility_hours(
            dec_degrees=60.0,
            latitude=40.0,
            month=6  # Summer
        )
    ...
    def test_rate_viewing_quality(self, service):
        ...
        rating = service._rate_viewing_quality(
            altitude=70.0,
            visibility_hours=10.0,
            is_evening=True
        )
    ...
    def test_calculate_best_observation_time(self, service):
        ...
        time = service._calculate_best_observation_time(
            ra_hours=6.0,  # Roughly midnight in winter
            month=1
        )
